...
import com.casadeshow.gerenciadordeeventos.services.CasaService;
...
public class CasaResources {
	...
	public ResponseEntity<Casa> buscarNome(
			@ApiParam(value = "Nome da casa", example = "Arena") @PathVariable("nome") String nome) {
