...
private  PrecoPassagemService precoPassagemService;
	...
	@Test
	public void deveCalcularValorPassagemParaPassageiroSiver_ComValorAbaixoDoLimite() throws Exception {
	...
	@Test
	public void deveCalcularValorPassagemParaPassageiroSiver_ComValorAcimaDoLimite() throws Exception {
		Passageiro passageiro = new Passageiro("Joao", TipoPassageiro.SILVER);
